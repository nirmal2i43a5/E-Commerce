...
function imageZoom(imgID){
	...
	let ratio = 3//for image ratio 1 means we can get original 2 means we can duplicate  by 200%  and so on 3 means 300%
	...
	function moveLens(){
        ...
        */
		...
		//5
		if(positionLeft < 0 ){
			positionLeft = 0//means cannot move lens to left positon when it is in 0 index
		}
